    ...
    public static async Task SeedAsync(HrDbContext context)
    {
        ...
        if (!await context.TaskCards.AnyAsync(t => t.CompletedAt != null))
        {
            ...
            var tasks = new List<TaskCard>
            {
                ...
                new TaskCard { Id = Guid.Parse("d1111111-1111-1111-1111-111111111111"), BoardId = board1Id, ColumnId = c1ProgressId, AssignedToId = sarahId, Title = "Q3 Marketing Campaign Launch", Priority = TaskPriority.Critical, CreatedById = hrUserId, Position = 1000, RowVersion = new byte[] { 1, 1, 1, 1, 1, 1, 1, 1 }, CreatedAt = DateTime.UtcNow.AddDays(-4), UpdatedAt = DateTime.UtcNow },
