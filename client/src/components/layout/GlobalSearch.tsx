      ...
      <div ref={containerRef} style={{ position: 'relative', width: '320px', maxWidth: '100%' }}>
        <div className="relative group">
          ...
          <input
            ...
            onFocusCapture={(e) => {
               e.currentTarget.style.borderColor = 'var(--accent, rgba(255, 255, 255, 0.15))';
               e.currentTarget.style.backgroundColor = 'var(--surface, rgba(0, 0, 0, 0.4))';
            }}
            onBlurCapture={(e) => {
               e.currentTarget.style.borderColor = 'var(--input-border, rgba(255, 255, 255, 0.05))';
               e.currentTarget.style.backgroundColor = 'var(--input-bg, rgba(0, 0, 0, 0.2))';
            }}
          />
          {query && (
            <button
        ...
        {isOpen && query.trim().length > 0 && (
          <div style={{
            ...
            left: 0,
            right: 0,
            backgroundColor: 'var(--surface-2, rgba(8, 8, 12, 0.95))',
                  ...
                  <div style={{ marginBottom: '8px' }}>
                    ...
                    {data?.employees.map((emp) => {
                      ...
                      return (
                        ...
                        >
                          <div style={{
                            width: '24px', height: '24px', borderRadius: '50%', backgroundColor: 'var(--accent, var(--border))', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '0.6rem', fontWeight: 700, color: '#fff', overflow: 'hidden', flexShrink: 0
                          }}>
