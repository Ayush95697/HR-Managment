          ...
          <div className="relative group">
            ...
            <div className="relative bg-black/40 backdrop-blur-xl rounded-2xl p-6 border border-white/[0.05] shadow-2xl overflow-hidden">
              ...
              <div className="text-center space-y-1 mb-5">
                ...
                >
                  <span className="text-lg font-bold bg-clip-text text-transparent bg-gradient-to-b from-white to-white/70">HR</span>
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                ...
                {errorMsg && (
                  <div className="bg-red-500/10 border border-red-500/20 text-red-400 text-xs p-2 rounded text-center">
                    {errorMsg}
                  </div>
                )}

                {/* Custom Role Selector embedded minimally */}
                <div className="flex gap-1 p-1 bg-white/5 rounded-lg">
                  {(['Admin', 'HR', 'Employee'] as Role[]).map((role) => (
                    <button
                      ...
                      className={cn(
                        "flex-1 text-[10px] sm:text-xs py-1.5 rounded-md transition-all duration-200",
                        selectedRole === role ? "bg-white/10 text-white font-semibold shadow-sm" : "text-white/50 hover:text-white/80"
                      )}
                    >
                      {role}
                    </button>
                ...
                <motion.div className="space-y-3">
                  ...
                  {errors.email && <span className="text-[10px] text-red-400 px-1 block">{errors.email.message}</span>}
                  ...
                  {errors.password && <span className="text-[10px] text-red-400 px-1 block">{errors.password.message}</span>}
                </motion.div>
                ...
                >
                  ...
                  <div className="relative overflow-hidden bg-white text-black font-medium h-10 rounded-full transition-all duration-300 flex items-center justify-center">
                    <motion.div 
                      ...
                      style={{ opacity: isSubmitting ? 1 : 0, transition: 'opacity 0.3s ease' }}
                    />
                ...
                >
                  <div className="absolute inset-0 bg-white/20 rounded-full blur opacity-0 group-hover/google:opacity-70 transition-opacity duration-300" />
                  
                  <div className="relative overflow-hidden bg-white text-black font-medium h-10 rounded-full border border-white/10 hover:border-white/20 transition-all duration-300 flex items-center justify-center gap-2">
                    <div className="w-4 h-4 flex items-center justify-center text-black/70 group-hover/google:text-black transition-colors duration-300 font-bold">G</div>
                    
                    <span className="text-black/80 group-hover/google:text-black transition-colors text-xs font-semibold">
                      Sign in with Google
                    </span>
              ...
              <div className="mt-6 pt-5 border-t border-white/5 text-center">
                <span className="text-[10px] text-white/40 block mb-2 uppercase tracking-wider">Quick-fill demo account</span>
                <div className="flex gap-2 justify-center">
                  <button type="button" onClick={() => quickFill('admin@hrsystem.com', 'Admin')} className="text-[10px] px-2 py-1 bg-white/5 hover:bg-white/10 text-white/70 rounded transition-colors">Admin</button>
                  <button type="button" onClick={() => quickFill('hr@hrsystem.com', 'HR')} className="text-[10px] px-2 py-1 bg-white/5 hover:bg-white/10 text-white/70 rounded transition-colors">HR</button>
                  <button type="button" onClick={() => quickFill('employee@hrsystem.com', 'Employee')} className="text-[10px] px-2 py-1 bg-white/5 hover:bg-white/10 text-white/70 rounded transition-colors">Employee</button>
                </div>
              </div>
